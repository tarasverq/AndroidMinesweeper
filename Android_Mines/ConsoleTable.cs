    ...
    public class ConsoleTable
    {
        ...
        public ConsoleTable AddRow(params object[] values)
        {
            ...
            if (Columns.Count != values.Length)
                throw new Exception("The number columns in the row does not match the values");
        ...
        public void Write(Format format = Android_Mines.Format.Default)
        {
            switch (format)
            {
                case Android_Mines.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case Android_Mines.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case Android_Mines.Format.Alternative:
